...
## The hard way
xmat <- emmeans:::tukey.emmc(levels(starling$SITUATION)) |> as.matrix()
starling_brm4 |>
    emmeans(~ MONTH | SITUATION) |>
    pairs() |>
...
starling_brm4 |>
    emmeans(~ MONTH | SITUATION) |>
  contrast(interaction = c("pairwise", "pairwise"), by = NULL)
...
starling_brm4 |>
    emmeans(~ MONTH | SITUATION) |>
  pairs() |>
  contrast(method = list(B = cmat), by = NULL)
  ## contrast(interaction = c("pairwise", B = cmat), by = NULL)
